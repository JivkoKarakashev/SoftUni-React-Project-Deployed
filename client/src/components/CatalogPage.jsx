...
const CatalogPage = () => {
    ...
    useEffect(() => {
        ...
        const requests = [
            ...
            fetch(`${import.meta.env.VITE_API_URL}/data/cars`, { signal: abortController.signal }),
            // fetch('http://localhost:3030/data/bought', { signal: abortController.signal })
            fetch(`${import.meta.env.VITE_API_URL}/data/bought`, { signal: abortController.signal })
        ];
