...
const SearchPage = () => {
    ...
    const searchHandler = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/data/cars?where=year>%3D${from} AND year<%3D${to} AND make%20LIKE%20%22${make}%22 AND model%20LIKE%20%22${model}%22`);
