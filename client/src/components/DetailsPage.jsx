...
const DetailsPage = () => {
    ...
    useEffect(() => {
        ...
        const requests = [
            ...
            fetch(`${import.meta.env.VITE_API_URL}/data/bought?where=productId%3D%22${id}%22&distinct=_ownerId&count`, { signal: abortController.signal }, options)
        ];
    ...
    const buyHandler = async (e) => {
        ...
        try {
            ...
            await fetch(`${import.meta.env.VITE_API_URL}/data/bought`, options);
